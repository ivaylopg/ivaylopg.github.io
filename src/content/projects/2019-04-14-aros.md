...
Created by Jules Laplace and Bethany Barrett using an automated tool that maps data points to harmonic scales which are then played through a Behringer DeepMind synthesizer, the inclusion of sound augments reality in another, non-visual, form that presents another perspective of both data analysis and social experience
