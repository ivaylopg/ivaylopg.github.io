...
Further developing his [earlier work](bob2018) with BOB, Cheng sought to give viewers a more meaningful agency in dictating BOB's development and mental evolution over time. As BOB would be showing worldwide, from Gladstone Gallery in NYC to the Venice Biennale and beyond, Cheng sought a less gallery-specific and more accessible approach. Forgoing the motion-tracked hardware from the Serpentine show, instead he sought to develop an widely available mobile app.
