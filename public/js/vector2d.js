/*
    A quick 2D vector implementation.

    Based on simplifications of the vector functions in P5.js. Useful for
    quick animations in JS using acceleration & velocity.
...
function Vector2d(x,y){                         // create a new instance using "new"
    ...
    this.rotateDegs = function (a) {            // rotates the vector by given angle in radians  
        a = (a * Math.PI)/180.0;                // v.rotateRads(angle_in_degrees)
